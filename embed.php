...
<script type="text/javascript">baseUrl = '<?php echo $CONF['url']; ?>'; token_id = '<?php echo $token_id; ?>'; viewed_id = 0; player_volume = '<?php echo $volume; ?>';  lng_just_now = '<?php $LNG['just_now']; ?>'; lng_ta_second = '<?php $LNG['ta_second']; ?>'; lng_ta_seconds = '<?php $LNG['ta_seconds']; ?>'; lng_ta_minute = '<?php $LNG['ta_minute']; ?>'; lng_ta_minutes = '<?php $LNG['ta_minutes']; ?>'; lng_ta_hour = '<?php $LNG['ta_hour']; ?>'; lng_ta_hours = '<?php $LNG['ta_hours']; ?>'; lng_ta_day = '<?php $LNG['ta_day']; ?>'; lng_ta_days = '<?php $LNG['ta_days']; ?>'; lng_ta_week = '<?php $LNG['ta_week']; ?>'; lng_ta_weeks = '<?php $LNG['ta_weeks']; ?>'; lng_ta_month = '<?php $LNG['ta_month']; ?>'; lng_ta_months = '<?php $LNG['ta_months']; ?>'; lng_ta_year = '<?php $LNG['ta_year']; ?>'; lng_ta_years = '<?php $LNG['ta_years']; ?>'; lng_ago = '<?php $LNG['ago']; ?>';</script>
